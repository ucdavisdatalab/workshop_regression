    ...
    config:
      toc:
        before: |
          ...
          <li><a href="./" style="font-size: 18px">A Practical 
Introduction to Regression Modeling</a></li>
        after: |
      ...
      sharing: no
      view: 
https://github.com/ucdavisdatalab/workshop_regression/blob/master/%s
      edit: 
https://github.com/ucdavisdatalab/workshop_regression/edit/master/%s
---
